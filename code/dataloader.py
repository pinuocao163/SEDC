...
class IEMOCAPRobertaCometDataset(Dataset):
    ...
    def __init__(self, path=None, split=None):
        ...
        self.xIntent, self.xAttr, self.xNeed, self.xWant, self.xEffect, self.xReact, self.oWant, self.oEffect, self.oReact \
            = pickle.load(open('E:\Code\Comparative\Comparative\data\iemocap\iemocap_features_comet.pkl', 'rb'), encoding='latin1')
    ...
    def collate_fn(self, data):
        dat = pd.DataFrame(data)
        return [pad_sequence(dat[i]) if i < 11 else pad_sequence(dat[i], True) if i < 13 else dat[i].tolist() for i in dat]
...
class MELDRobertaCometDataset(Dataset):
    ...
    def __init__(self, path=None, split=None, classify='emotion'):
        ...
        self.xIntent, self.xAttr, self.xNeed, self.xWant, self.xEffect, self.xReact, self.oWant, self.oEffect, self.oReact \
            = pickle.load(open('E:\Code\Comparative\Comparative\data\meld\meld_features_comet.pkl', 'rb'), encoding='latin1')
    ...
    def collate_fn(self, data):
        dat = pd.DataFrame(data)
        return [pad_sequence(dat[i]) if i < 14 else pad_sequence(dat[i], True) if i < 16
...
class DailyDialogRobertaCometDataset(Dataset):
    ...
    def __init__(self, path=None, split=None, classify='emotion'):
        ...
        self.xIntent, self.xAttr, self.xNeed, self.xWant, self.xEffect, self.xReact, self.oWant, self.oEffect, self.oReact \
            = pickle.load(open('E:\Code\Comparative\Comparative\data\dailydialog\dailydialog_features_comet.pkl', 'rb'),
                          encoding='latin1')
    ...
    def collate_fn(self, data):
        dat = pd.DataFrame(data)
        return [pad_sequence(dat[i]) if i < 9 else pad_sequence(dat[i], True) if i < 13 else dat[i].tolist() for i in
                dat]
...
class EmoryNLPRobertaCometDataset(Dataset):
    ...
    def __init__(self, path=None, split=None, classify='emotion'):
        ...
        self.xIntent, self.xAttr, self.xNeed, self.xWant, self.xEffect, self.xReact, self.oWant, self.oEffect, self.oReact \
            = pickle.load(open('E:\Code\Comparative\Comparative\data\emorynlp\emorynlp_features_comet.pkl', 'rb'), encoding='latin1')
    ...
    def collate_fn(self, data):
        dat = pd.DataFrame(data)
        return [pad_sequence(dat[i]) if i < 11 else pad_sequence(dat[i], True) if i < 13 else dat[i].tolist() for i in
                dat]