...
def train_or_eval_model(model, loss_f, dataloader, train_flag=False, optimizer=None, cuda_flag=False, feature_type='text', target_names=None):
    ...
    for data in dataloader:
        ...
        roberta_fea_1, roberta_fea_2, roberta_fea_3, roberta_fea_4, xIntent, xAttr, xNeed, xWant, xEffect, xReact, oWant, oEffect, oReact, qmask, umask, label2 = [d.cuda() for d in data[:-1]] if cuda_flag else data[:-1]
        roberta_fea = (roberta_fea_1 + roberta_fea_3 + roberta_fea_4) / 3
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dropout', type=float, default=0.0, metavar='dropout', help='dropout rate')
    ...
    parser.add_argument('--gamma', type=float, default=0, help='gamma 0/0.5/1/2')
